...
if __name__ == '__main__':
    # Render deployment-ku environment variables port use pannanum
    port = int(os.environ.get("PORT", 5000))
    # host='0.0.0.0' kudutha dhaan Render-la access panna mudiyum
